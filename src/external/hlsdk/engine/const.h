...
//
// const.h -- Miscellaneous Half-Life constants
//
...
#define EF_MASK					(32 - 1)  // Used to mask against curstate.effects
...
#define	FTENT_SINEWAVE			0x00000001 // particles flow in a sine wave
#define	FTENT_GRAVITY			0x00000002 // Regular gravity
#define FTENT_ROTATE			0x00000004
#define	FTENT_SLOWGRAVITY		0x00000008 // Slowed gravity
...
#define FTENT_CORPSE 			0x00100000 // CSTRIKE: Entity is a corpse (CreateCorpse function)
#define FTENT_CORPSE_COLLISION	0x00200000 // CSTRIKE: Set when hitting a body

// Mask for breakable models
#define FTENT_BREAK_TYPEMASK	(FTENT_SINEWAVE | FTENT_GRAVITY | FTENT_ROTATE | FTENT_SLOWGRAVITY | FTENT_FLICKER)

// Hunks used by COM_LoadFile() for allocation
#define HUNK_ZONE_MALLOC		0 // Z_Malloc()
#define HUNK_NAME				1 // Hunk_AllocName()
#define HUNK_TEMP				2 // Hunk_TempAlloc()
#define HUNK_CACHE				3 // Cache_Alloc()
#define HUNK_TEMP_OVERFLOW		4 // Same as HUNK_TEMP but with size overflow check
#define HUNK_MALLOC				5 // Mem_Malloc()

// Blending modes for sprites. Handled inside R_DrawSpriteModel().
enum
{	
	kRenderNormal,			// src
...
struct colorVec
{
	unsigned r, g, b, a; // 0x0000 - 0xFFFF light
};
...
// Four mip levels (dividing a texture into four different sizes, sort
// of like icons are divided inside the ico file)
#define MIP_1x1						0 // The original image
#define MIP_1x4						1 // Original divided by 4
#define MIP_1x16					2 // Original divided by 16
#define MIP_1x64					3 // Original divided by 64
#define MIP_LEVELS					4 // Amount of mip levels per texture

enum
{
	MAX_PLAYERS = 64, // including the bomb
	MAX_TEAMS = 64,
	MAX_TEAM_NAME = 16,
	MAX_HOSTAGES = 24,
};
