...
namespace ImGui
{
    ...
    IMGUI_API void          SetNextWindowRounding(float rounding, ImDrawFlags flags);                   // rounding flags and amount of the window
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_NoLabel             = 1 << 21,  // oxware: added
...
enum ImGuiTableFlags_
{
    ...
    // oxware added
    ImGuiTableFlags_HeaderTextOnly             = 1 << 28,  
